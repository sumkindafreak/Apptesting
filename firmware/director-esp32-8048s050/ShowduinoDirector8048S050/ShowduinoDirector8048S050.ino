/*
  ...
  - lvgl 9.x
  - Arduino_GFX_Library 1.4.x or newer
  - TAMC_GT911
...
// Arduino_GFX >= 1.4: timing lives on Arduino_ESP32RGBPanel;
// use Arduino_RGB_Display instead of Arduino_RPi_DPI_RGBPanel.
// =========================================================
...
Arduino_RGB_Display *gfx = new Arduino_RGB_Display(
  SCREEN_WIDTH, SCREEN_HEIGHT, rgbBus, 0, true
);
